    ...
    <div>
        ...
        <div class="contentDiv">
            <el-form class="condition" label-width="100px">
                ...
                <el-row>
                    <el-col style="width: 400px;" class="tip">目前会员 <em style="color:#e4393c;">{{total}}</em>,
                                                              商家 <em style="color:#e4393c;">{{total}}</em>
                                                              运营商<em style="color:#e4393c;">{{total}}</em>
                                                              代理<em style="color:#e4393c;">{{total}}</em>
                                    可根据条件进行详细筛选
                    </el-col>
                ...
                <tr v-for="item in list">
                    ...
                    <td>
                        <el-tooltip class="item" effect="dark" content="点击查看" placement="top">
                            <router-link to="/carriorMember/member"><span class="curr">{{item.invite_member_count}}</span></router-link>
                        </el-tooltip>
                    </td>
