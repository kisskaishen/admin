<template>
    <div>
        <el-breadcrumb separator=">">
            <el-breadcrumb-item to="/carrierOperator">运营商</el-breadcrumb-item>
            <el-breadcrumb-item>{{this.$route.query.type=='revise'?'修改运营商':'审核运营商'}}</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="contentDiv">
            <p class="tip">{{this.$route.query.type=='revise'?'修改运营商':'审核运营商'}}</p>
            <el-form label-width="180px">
                ...
                <el-form-item label="运营商类型：">
                    <span>{{userInfo.identity==0?'正式运营商':userInfo.identity==1?'分期运营商':'合伙人运营商'}}</span>
                </el-form-item>

                <el-form-item label="总额：" v-if="userInfo.identity!=2">
                    <span>{{userInfo.totalpayment}}</span>
                </el-form-item>

                <el-form-item label="分期数：" v-if="userInfo.identity==1">
                    <span>{{userInfo.changetype_userInfo}}</span>
                </el-form-item>

                <el-form-item label="每期应付金额：" v-if="userInfo.identity==1">
                    <span>{{userInfo.eachpayment}}</span>
                </el-form-item>

                <el-form-item label="预先支付分期数：" v-if="userInfo.identity==1">
                    <span>{{userInfo.paidtime}}</span>
                </el-form-item>

                <el-form-item label="需支付金额：" v-if="userInfo.identity==1">
                    <span>{{userInfo.paidpaymemt}}</span>
                </el-form-item>

                <el-form-item label="到期时间：" v-if="userInfo.identity!=0">
                ...
                <el-form-item label="审核状态：">
                    <span>{{userInfo.status_info}}</span>
                </el-form-item>

                <el-form-item label="加盟时间：">
                    <span>{{userInfo.member_time}}</span>
                </el-form-item>
                ...
                <el-form-item label="推荐人：">
                    <span>{{userInfo.yinviter_name}}</span>
                </el-form-item>
                ...
                <el-form-item label="法人身份证扫描件：">
                    <div class="file">
                        ...
                        <div>身份证正面</div>
                        <span v-if="identityImgUrl" class="seeBig" @click="seeBig">查看大图</span>
                    </div>
                    <div class="file">
                ...
                <el-form-item label="审核：" v-if = "this.$route.query.type == 'check'">
                    <el-radio-group v-model="check" @change="checkChange">
                ...
                <el-form-item>
                    <div class="btnDiv">
                        ...
                        <el-button type="danger" @click="submitRevise">提交</el-button>
                    </div>
                </el-form-item>
            </el-form>
            <div class="img-view">
