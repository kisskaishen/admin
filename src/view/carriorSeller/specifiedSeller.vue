        ...
        <div class="contentDiv">
            ...
            <table>
                ...
                <tr v-for="item in list">
                    ...
                    <td align="center"><span @click="isClose(item)">{{item.is_close}}</span></td>
                    <td align="center"><span @click="toDialog(item)" style="color: #e4393c;">指定</span></td>
                </tr>
            </table>
                ...
                <div class="dialogDiv">
                    <el-row>
                        ...
                        <el-col :span="4" style="padding-left: 20px;">
                            <el-button type="danger" size="small" @click="searchName">查询</el-button>
                        </el-col>
                    </el-row>
                    <ul>
