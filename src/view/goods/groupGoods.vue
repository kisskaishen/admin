        ...
        <div class="contentDiv">
            ...
            <div class="photoList">
                ...
                <div class="file">
                    ...
                    <div @change="upload">上传套餐券图片</div>
                </div>
                <div class="file">
                    <img v-if="imageUrl2" :src="imageUrl2" class="avatar" alt="套餐券图片">
                    <i v-else class="el-icon-banner"></i>
                    <input ref="files" type="file" name="avatar" @change="upload2">
                    <div @change="upload2">上传套餐券图片</div>
                </div>
                <div class="file">
                    <img v-if="imageUrl3" :src="imageUrl3" class="avatar" alt="套餐券图片">
                    <i v-else class="el-icon-banner"></i>
                    <input ref="files" type="file" name="avatar" @change="upload3">
                    <div @change="upload3">上传套餐券图片</div>
                </div>
            </div>
            ...
            <div class="goodsList">
                ...
                <el-row>
                    ...
                    <el-col style="width:160px;float:right;margin-top:4px;">
                        ...
                        <span class="fl" style="margin:0 10px;">选</span>
                        <el-input v-model="foodsChoose" size="mini" class="fl" style="width:60px;"></el-input>
                    </el-col>
                </el-row>
                <div>
            ...
            <div class="goodsOther">
                <el-form label-width="180px">
                    ...
                    <el-form-item label="是否同时享有其他优惠：">
                        ...
                        <el-input v-model="otherCoupon" v-show="couponShow" placeholder="请填写其他优惠说明" size="small"
                                  style="width:180px;margin-left:20px;"></el-input>
                    </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            addGroup() {
                ...
                } else if (JSON.stringify(this.imageArr) == '') {
                    this.$message({
                        message: '至少上传图片!',
                        type: 'warning',
                        duration: 1600
...
//                            gc_id_1: this.levelId,               // 一级分类
//                            gc_id_2: this.level2Id               // 二级分类
                        }
                    })
                        .then(res => {
                            if (res.data.code == 200) {
                                ...
                                setTimeout(this.$router.push('/seller'), 1600)
