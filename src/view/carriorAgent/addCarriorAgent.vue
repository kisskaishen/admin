        ...
        <div class="contentDiv">
            ...
            <el-form label-width="180px">
                ...
                <el-form-item label="运营商推荐人：" required>
                    <el-select v-model="carriorReferee" @change="refereeChange">
                        <el-option
                            v-for="item in referees"
                            :key="item.member_id"
                            :label="item.label"
                            :value="item.member_name+'('+item.member_id+')'"></el-option>
                    </el-select>
...
<script>
    //    import AgentAddress from '../../components/public/addressSelect4'
    ...
    export default {
        ...
        methods: {
            ...
            // 确认新增
            submitAdd() {
                if (this.memberVal == true || this.telVal == true || this.identityVal == true || this.bankVal == true || this.carriorName == '' || this.carriorPwd == '' || this.peopleName == '' || this.address == '' || this.morea == '') {
                    this.$message({
                        type: 'error',
                        message: '请输入正确的信息!',
                        duration: 1600
                    ...
                    this.$axios({
                        ...
                        data: {
                            ...
                            yinviter_id: this.carriorRefereeId,
