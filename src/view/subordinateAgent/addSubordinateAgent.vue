...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 确认新增
            submitAdd() {
                if (this.agentName == '' || this.tel == '' || this.revisePwd == '' || this.peopleName == '' || this.origination == '' || this.licenseNum == '' || this.peopleIdentity == '' || this.openName == '' || this.openBankName == '' || this.openBankAccount == '') {
                    alert('请填写完全信息！')
                } else {
                    this.$axios({
                        method: 'post',
