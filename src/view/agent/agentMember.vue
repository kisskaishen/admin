<template>
    <div>
        ...
        <div class="contentDiv">
            <div class="agentInfo">
                <span>代理：{{agentInfo.member_name}}</span>
                <span>代理地区：{{agentInfo.address}}</span>
                <span>注册会员：{{agentInfo.member_num}}</span>
                <span>VIP会员：{{agentInfo.vip_member_num}}</span>
            </div>
...
<script>
    export default {
        ...
        created() {
            this.is_vip = this.$route.query.is_vip
            // 列表
