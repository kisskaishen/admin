<template>
    <div>
        <el-breadcrumb separator=">">
            ...
            <el-breadcrumb-item>代理提现</el-breadcrumb-item>
        </el-breadcrumb>
            ...
            <el-form>
                <table>
                    ...
                    <tr class="tbody" v-for="td in tdes">
                        ...
                        <td>{{td.farennum}}</td>
                        <td>{{td.time}}</td>
                        <td><span :class="[td.status_info=='成功'?'curr2':td.status_info=='未处理'?'curr4':'curr']">{{td.status_info}}</span></td>
                        <td>
                            <router-link :to="{path:'/agent/watchCash',query:{member_id:td.member_id,id:td.id}}"><span class="curr5">查看</span></router-link>
                            <router-link :to="{path:'/agent/cashCheck',query:{member_id:td.member_id,id:td.id}}"><span class="curr">{{td.is_examine}}</span></router-link>
                        </td>
                    </tr>
                </table>
                <el-pagination
