<template>
    <div>
        <el-breadcrumb separator=">">
            <el-breadcrumb-item :to="{path:'/member'}">代理商</el-breadcrumb-item>
            <el-breadcrumb-item :to="{path:'/member/memberCash'}">代理商提现</el-breadcrumb-item>
            <el-breadcrumb-item>代理商提现查看</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="contentDiv">
            ...
            <el-form class="listDiv" label-width="140px">
                ...
                <el-form-item label="审核时间：">
                    <span :class="[cashInfo.status == '未处理'?'curr3':cashInfo.status == '成功'?'curr2':'curr']">{{cashInfo.status}}</span>
                </el-form-item>
                ...
                <el-form-item label="失败原因：" v-if="cashInfo.status == '失败'">
                    <span>{{cashInfo.re_note}}</span>
                </el-form-item>
