<template>
    <div>
        <el-breadcrumb separator=">">
            ...
            <el-breadcrumb-item>商家入住申请审核</el-breadcrumb-item>
        </el-breadcrumb>
            ...
            <el-form label-width="180px">
                ...
                <el-form-item label="营业执照：" required>
                    ...
                    <div class="file">
                        ...
                        <span class="seeBig" @click="seeBig">查看大图</span>
                    </div>
                </el-form-item>
                ...
                <el-form-item label="审核：" required>
                    <el-radio-group v-model="checkSeller" @change="checkSellerRadio">
                        <el-radio label='40'>审核通过开店</el-radio>
                        <el-radio label='30'>审核失败</el-radio>
                    </el-radio-group>
                    <br/>
                    <el-input type="textarea" v-model="refuseReason" v-if="showRefuseReason"
                ...
                <el-form-item class="btnDiv">
                    ...
                    <el-button type="danger" @click="submitForm()" :disabled="submitBtnDisabled">{{checkText}}</el-button>
                </el-form-item>
            </el-form>
            <div class="img-view">
    ...
    export default {
        data() {
            return {
                ...
                checkSeller: '40',				// 审核结果
                showRefuseReason: false,			// 拒绝理由框
                refuseReason: '',				// 拒绝理由

                layerImg: '',         //放大图片
                showImg: false,

                submitBtnDisabled:false,        // 点击一次之后禁止点击，3s后解锁
            ...
            this.$axios({
                ...
                .then(res => {
                    if (res.data.code == 200) {
                        ...
                        this.sellerAccount = res.data.data.member_name
                        this.sellerName = res.data.data.store_name
                        this.level1Value = res.data.data.p_sc_id_name + '(' + res.data.data.p_sc_id + ')'
                        this.level2Value = res.data.data.sc_id_name + '(' + res.data.data.sc_id + ')'


                        this.sellerLocationLong = res.data.data.longitude
                        this.sellerLocationLat = res.data.data.latitude
                        this.sellerCorporation = res.data.data.company_master
                        this.sellerIdentity = res.data.data.id_card_no
                        this.sellerTel = res.data.data.contacts_phone
                        this.sellerServerTel = res.data.data.company_phone
                        this.sellerReferee = res.data.data.inviter_name

                        this.showAddress = res.data.data.company_address_detail                 
                        ...
                        this.LicenceImgUrl = res.data.data.addstore_image_03
        ...
        methods: {
            ...
            submitForm() {
                ...
                this.checkText = '5S后解锁'
                setTimeout(this.disabledFunc,5000)
                // addstoreImage1
                ...
                if (this.provinceId != '' || this.detail != '') {
                    this.$axios({
                        method: 'post',
                        url: 'store/audit_store',
                        data: {
                            'id': this.applicateId,
                            ...
                            'narea_p': this.provinceId,                // 1124骚包叫改成id
                            'narea_s': this.cityId,
                            'narea_q': this.areaId,
                            'narea_z': this.streetId,
                            'company_address_detail': this.detail,

                            'four_narea':this.provinceVal+''+this.cityVal+''+this.areaVal+''+this.streetVal,
                            ...
                            'joinin_state': this.checkSeller,
                            'joinin_message': this.refuseReason,
                        }
                    })
                        .then(res => {
                            ...
                            if (res.data.code == 200) {
                                ...
                                setTimeout(this.$router.push('/seller/SellerIn'), 1600)
                            } else {
                                this.$notify({
                                    title: '失败',
                                    message: res.data.message,
                    ...
                    this.$message.error('地址为必填选项！')
                }

            },
            // 返回商家申请列表
            resetForm() {
                this.$router.push('/seller/sellerIn')
            },
            // 上传或修改照片
            // 修改营业执照
            reviseLicence(e) {
