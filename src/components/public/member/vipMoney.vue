		...
		<div class="contentDiv">
            ...
            <template>
            	<el-table
					...
					<el-table-column prop="old_amount" label="变动前的奖金" width="150"></el-table-column>
					<el-table-column prop="value"  label="变动金额" width="120"></el-table-column>
					<el-table-column prop="new_amount" label="变动后的奖金" width="150"></el-table-column>
	...
	export default {
		...
		methods:{
            ...
            outExcel() {
                ...
                '&user_name=' + this.userName + '&order_sn=' +this.orderSn + '&type=1&is_outexcel=1'
            },
            startDateChange(val) {
                this.startDate = val
            },
