		...
		<div class="contentDiv">
            ...
            <template>
            	<el-table
					...
					<el-table-column prop="type" label="奖金变动的类型"></el-table-column>
					<el-table-column prop="cm_id" label="消费者id" width="100"></el-table-column>
					<el-table-column prop="user_name" label="消费者用户名"></el-table-column>
					...
					<el-table-column prop="profit_price" label="订单利润" width="100"></el-table-column>
					<el-table-column prop="old_amount"  label="变动前的奖金"></el-table-column>
					<el-table-column prop="value" label="变动金额"></el-table-column>
					<el-table-column prop="new_amount" label="变动后的奖金"></el-table-column>
	...
	export default {
		...
		methods:{
            ...
            outExcel() {
                ...
                '&user_name=' + this.userName + '&order_sn=' +this.orderSn + '&type=3&is_outexcel=1'
            },
            startDateChange(val) {
                this.startDate = val
            },
