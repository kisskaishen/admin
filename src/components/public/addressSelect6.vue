    ...
    <div>
        ...
        <el-form>
            <el-row>
                ...
                <el-col>
                    <el-form-item>
                        <el-select v-model="province" placeholder="请选择省份" size="small" @change="proChange">
                            <el-option
                ...
                <el-col>
                    <el-form-item>
                        <el-select v-model="city" placeholder="请选择市" size="small" @change="cityChange">
                            <el-option
                ...
                <el-col>
                    <el-form-item>
                        <el-select v-model="area" placeholder="请选择区" size="small" @change="areaChange">
                            <el-option
                                v-for="item in areas"
                                :key="item.area"
                                :label="item.label"
                ...
                <el-col>
                    <el-form-item>
                        <el-select v-model="street" placeholder="请选择/街道/镇" size="small" @change="streetChange">
                            <el-option
